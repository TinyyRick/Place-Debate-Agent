...
const RegeoSchema = z.object({ status: z.string(), info: z.string(), regeocode: z.object({ formatted_address: z.string().optional(), addressComponent: z.object({ province: z.string().optional(), city: z.union([z.string(), z.array(z.string())]).optional(), district: z.string().optional(), adcode: z.string().optional(), citycode: z.union([z.string(), z.array(z.string())]).optional() }).optional() }).optional() });
...
export async function reverseGeocode(amapCoordinates: Coordinates, fetcher: typeof fetch = fetch) {
  ...
  return { formattedAddress: payload.regeocode.formatted_address, province: component.province, city: typeof component.city === "string" ? component.city : undefined, district: component.district, adcode: component.adcode, cityCode: typeof component.citycode === "string" ? component.citycode : undefined };
}
